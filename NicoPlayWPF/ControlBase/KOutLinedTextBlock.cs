...
public class KOutlinedTextBlock : FrameworkElement
{
    ...
    {
        var KOutlinedTextBlock = (KOutlinedTextBlock)dependencyObject;
        KOutlinedTextBlock.formattedText = null;
        KOutlinedTextBlock.textGeometry = null;

        KOutlinedTextBlock.InvalidateMeasure();
        KOutlinedTextBlock.InvalidateVisual();
    }

    private static void OnFormattedTextUpdated(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
    {
        var KOutlinedTextBlock = (KOutlinedTextBlock)dependencyObject;
        KOutlinedTextBlock.UpdateFormattedText();
        KOutlinedTextBlock.textGeometry = null;
